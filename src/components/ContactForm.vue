<template>
  <section class="relative overflow-hidden bg-[#f8f0ea] contact-bg">
    <div
      class="hidden lg:block absolute right-0 bottom-0 h-full w-full lg:w-4/12"
    >
      <img
      ...
      <div class="max-w-5xl mx-auto">
        <div class="flex flex-wrap -mx-4 py-20 2xl:py-40">
          <div class="w-full lg:w-2/5 px-4 mb-8 lg:mb-0">
            <span class="text-lg font-bold text-[#02073e]"
              >Contact with us</span
            >
            <h2
              class="mt-8 mb-12 md:mb-20 text-5xl font-bold font-heading text-[#0f2137]"
            >
              Our Office in Kathmandu
            </h2>
            <div class="flex py-6 border-b border-gray-50">
              <span
                class="flex items-center justify-center w-12 h-12 mr-8 bg-[#0a8080] rounded-lg"
              >
                <svg
                  class="w-4 h-4"
                  width="18"
              ...
              <p class="text-lg font-bold">+977-9845789755457</p>
            </div>
            <div class="flex items-center py-6 border-b border-gray-50">
              ...
              <p class="text-lg font-bold">support@techogma.com</p>
            </div>
            <div class="flex items-center py-6">
              <span
                class="flex flex-shrink-0 items-center justify-center w-12 h-12 mr-8 bg-[#0a8080] rounded-lg"
              >
                <svg
                  class="w-5 h-5"
                  width="23"
              ...
              <div>
                ...
                <p class="text-gray-300">Opening hours : 8am - 6pm</p>
              </div>
            </div>
          </div>
          <div class="w-full lg:w-3/5 px-4">
            <div
              class="lg:ml-20 px-8 lg:px-12 py-16 w-full lg:max-w-md bg-white shadow-lg rounded-lg"
            >
              <form action="#">
                ...
                <input
                  class="mb-4 w-full px-12 py-4 bg-white border font-bold placeholder-gray-900 rounded-full focus:outline-none text-[#0f2137]"
                  type="email"
                  placeholder="example@techogma.com"
                />
                <input
                  class="mb-4 w-full px-12 py-4 bg-white border font-bold placeholder-gray-900 rounded-full focus:outline-none text-[#0f2137]"
                  type="text"
                ...
                />
                <textarea
                  class="w-full mb-6 px-12 py-4 bg-white border font-bold placeholder-gray-900 rounded-3xl resize-none focus:outline-none text-[#0f2137]"
                  name=""
                  id=""
                  cols="30"
                  rows="10"
                ...
                <div class="flex mb-10">
                  <input type="checkbox" />
                  <p class="pl-4 max-w-xs text-sm text-gray-400">
                ...
                <div class="text-right">
                  <button
                    class="py-4 px-12 text-white font-bold bg-[#0a8080] hover:bg-[#298d8d] rounded-full transition duration-200"
                  >
                    Send
                  </button>
                </div>
...
<style scoped>
/* .contact-bg {
  background: url("../assets/contact_svg.svg");
